...
if __name__ == "__main__":
    ...
    llama_installed = check_model_with_ollama("llama3.2:90b-vision")
    if llama_installed:
    ...
    qwq_installed = check_model_with_ollama("qwen2.5-coder:32b")
    if qwq_installed:
        print(f"{green}Qwen2.5 Coder is installed.{reset}\n")
    else:
        print(f"{yellow}Qwen2.5 Coder is not installed.{reset}\n")
        if ollama_installed:
            install_model_with_ollama("qwen2.5-coder:32b")
