...
if __name__ == "__main__":
    ...
    # Check if QwQ is installed
    qwq_installed = check_model_with_ollama("qwq")
    if qwq_installed:
        print(f"{green}QwQ is installed.{reset}")
    else:
        print(f"{yellow}QwQ is not installed.{reset}")
        if ollama_installed:
            install_model_with_ollama("qwq")
