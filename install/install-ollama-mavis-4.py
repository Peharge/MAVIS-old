...
if __name__ == "__main__":
    print("\nOllama Information:")
    print("-------------------")
    print("You can select the main model later in the MAVIS UI and it will be installed automatically!")
    ...
    models_to_check = ["llama3.2-vision:11b", "qwen2.5:1.5b", "granite3.2-vision"]
