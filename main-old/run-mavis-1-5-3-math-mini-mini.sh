...
# English Peharge: This source code is released under the MIT License.
# Usage Rights:
...
SCRIPT_PATH_1="/home/$USERNAME/PycharmProjects/MAVIS/info/info-start-mavis-1-5-3-math-mini-mini.py"
...
SCRIPT_PATH_3="/home/$USERNAME/PycharmProjects/MAVIS/install/install-ollama-mavis-1-5-3-math-mini-mini.py"
SCRIPT_PATH_4="/home/$USERNAME/PycharmProjects/MAVIS/info/info-mavis-1-5.py"
...
SCRIPT_PATH_5="/home/$USERNAME/PycharmProjects/MAVIS/mavis-1-5-3-main-math-mini-mini.py"
...
# Check if script 1 exists and run it
...
# Check if script 2 exists and run it
...
# Check if update script exists and run it
...
# Check if script 3 exists and run it
...
# Check if script 4 exists and run it
...
# Check if run-jup exists and run it in the background
if [ ! -f "$run_jup" ]; then
    echo "Error: Python script not found: $run_jup"
    exit 1
fi
nohup "$PYTHON_PATH" "$run_jup" &
...
# Check if script 5 exists and run it
