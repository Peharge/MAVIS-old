...
def display_versions():
    ...
    versions = {
        ...
        "mavis-3-code-pro": "MAVIS 3 EAP",
        "mavis-3-math": "MAVIS 3 EAP",
        "mavis-3-math-pro": "MAVIS 3 EAP",
        "mavis-3-mini": "MAVIS 3 EAP",
        "mavis-3-mini-mini": "MAVIS 3 EAP"
    }
...
def get_user_input(versions):
    ...
    while True:
        user_input = input(f"Enter a MAVIS batch file (e.g. 'mavis-5-main'):").strip()
