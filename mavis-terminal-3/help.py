...
def show_help():
    ...
    commands = {
        ...
        "install ollama mavis-3-main": "Installs Ollama for the Mavis 3 main version.",
        "install ollama mavis-3-math": "Installs Ollama for the Mavis 3 math version.",
        "install ollama mavis-3-code": "Installs Ollama for the Mavis 3 code version.",
