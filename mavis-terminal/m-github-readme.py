...
required_packages = ["PyQt6", "PyQt6-sip", "PyQt6-WebEngine", "PyQt6-Charts"]
...
class BrowserWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("MAVIS GitHub Repository")
        ...
        self.browser.setUrl(QUrl("https://github.com/Peharge/MAVIS?tab=readme-ov-file#readme"))
