...
QScrollBar:vertical {
    background-color: #ffffff;  /* Hintergrund (Schiene) in Weiß */
    width: 10px;
    border-radius: 5px;
}
...
QScrollBar:horizontal {
    background-color: #ffffff;  /* Auch der horizontale Balken in Weiß */
    height: 10px;
    border-radius: 5px;
}
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MAVIS SIMON Info")
    ...
    def setup_ui(self):
        ...
        try:
            ...
            logo_path = os.path.join("C:\\", "Users", os.getlogin(), "PycharmProjects", "MAVIS", "icons", "simon-logo.ico")
        except Exception:
            logo_path = ""
