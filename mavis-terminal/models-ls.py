...
def fetch_models():
    ...
    return [
        {"name": "Xc++ I 11b (only pro users)", "version": "xcpp:11b", "category": "Vision Tool", "rating": 4},
        {"name": "Xc++ II 11b (only pro users)", "version": "xcpp2:11b", "category": "Vision Tool", "rating": 5},
        {"name": "Xc++ III 11b (only pro users)", "version": "xcpp3:11b", "category": "Vision Tool", "rating": 5},
        {"name": "Xc++ IV 11b (only pro users)", "version": "xcpp4:11b", "category": "Vision Tool", "rating": 6},
        {"name": "Chat++ I 70b (only pro users)", "version": "chatpp1:70b", "category": "Vision Tool", "rating": 2},
        {"name": "Chat++ II 70b (only pro users)", "version": "chatpp2:70b", "category": "Vision Tool", "rating": 2},
        {"name": "Chat++ III 70b (only pro users)", "version": "chatpp3:70b", "category": "Vision Tool", "rating": 3},
        {"name": "Chat++ IV 70b (only pro users)", "version": "chatpp4:70b", "category": "Vision Tool", "rating": 4},
        {"name": "Chat++ mini 8b (only pro users)", "version": "chatppmini:8b", "category": "Vision Tool", "rating": 4},
        {"name": "Chat++ V 70b (only pro users)", "version": "chatpp5:70b", "category": "Vision Tool", "rating": 5},
        {"name": "Woyzy 8b (only pro users)", "version": "woyzy:8b", "category": "Vision Tool", "rating": 4},
        ...
        {"name": "DeepCodern 1.5b", "version": "deepcoder:1.5b", "category": "Language Model", "rating": 5},
        {"name": "DeepCodern 14b", "version": "deepcoder:14b", "category": "Language Model", "rating": 5},
