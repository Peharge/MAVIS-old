...
set SCRIPT_PATH_1=C:\Users\%USERNAME%\PycharmProjects\MAVIS\info\info-start-mavis-1-2-mini-mini.py
set SCRIPT_PATH_2=C:\Users\%USERNAME%\PycharmProjects\MAVIS\install\install.py
set SCRIPT_PATH_3=C:\Users\%USERNAME%\PycharmProjects\MAVIS\install\install-ollama-mavis-1-2-mini-ini.py
...
set SCRIPT_PATH_5=C:\Users\%USERNAME%\PycharmProjects\MAVIS\main\mavis-1-2-main-mini-mini.py
