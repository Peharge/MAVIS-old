...
set SCRIPT_PATH_1=C:\Users\%USERNAME%\PycharmProjects\MAVIS\info\info-start-mavis-3-math.py
set SCRIPT_PATH_2=C:\Users\%USERNAME%\PycharmProjects\MAVIS\install\install-info-mavis-3.py
...
set SCRIPT_PATH_3=C:\Users\%USERNAME%\PycharmProjects\MAVIS\install\install-ollama-mavis-3-math.py
set SCRIPT_PATH_security=C:\Users\%USERNAME%\PycharmProjects\MAVIS\security\security_check.py
set SCRIPT_PATH_4=C:\Users\%USERNAME%\PycharmProjects\MAVIS\info\info-mavis-3.py
...
set run_solution=C:\Users\%USERNAME%\PycharmProjects\MAVIS\solution-main-3.py
set SCRIPT_PATH_5=C:\Users\%USERNAME%\PycharmProjects\MAVIS\mavis-3-main-math.py
