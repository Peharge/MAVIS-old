...
# Pfade für den Python-Interpreter und das Skript
PYTHON_PATH="$HOME/PycharmProjects/MAVIS/.env/bin/python"
SCRIPT_PATH_1="$HOME/PycharmProjects/MAVIS/mavis-installer-4-main-linux.py"
